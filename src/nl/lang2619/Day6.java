...
public class Day6 {
    ...
    private static void part2() {
        for (String s : input) {
            if (s.contains("on")) {
                ...
                int x = Integer.parseInt(firstXY[0]);
                int y = Integer.parseInt(firstXY[1]);
    ...
    private static void output() {
        ...
        System.out.println("Total on : " + totalLights);
        System.out.println("-------------------------");
    }
