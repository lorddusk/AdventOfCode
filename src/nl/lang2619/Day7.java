...
public class Day7 {
    ...
    public static void main(String... argv) {
        ...
        System.out.println(factory.get("a").solve());
    }
        ...
        public int solve() {
            ...
            switch (type) {
                ...
                case "RSHIFT":
                    return wire1.solve() >> wire2.solve();
                default:
                    throw new IllegalArgumentException("Unknown gate: " + type);
            }
        }
    }
}
